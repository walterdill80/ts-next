  ...
  return (
    <footer className="border-t border-[hsl(0_0%_10%)] py-12 mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center gap-4">
            {socialLinks.map((s) => (
              <a
                ...
                aria-label={s.label}
                className="text-[hsl(0_0%_35%)] hover:text-[hsl(43_48%_59%)] transition-colors duration-200"
              >
                {s.icon}
              </a>
            ))}
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-6 border-t border-[hsl(0_0%_10%)]">
          {/* Nav Links */}
